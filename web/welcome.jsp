...
<body>
                ...
                <div class="d-inline-flex align-items-center">
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="custregister.jsp" class="dropdown-item">Sign up</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="carousel-item position-relative active" style="height: 430px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Products that suit the exact needs of our clients at the most affordable prices in town</p>
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="login.jsp">Shop Now</a>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Footer Start -->
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5" id="contactus">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                <h5 class="text-secondary text-uppercase mb-4">Get In Touch</h5>
                <p class="mb-4">Products that suit the exact needs of our clients at the most affordable prices in town</p>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>123 Kikoni Street, Kampala, UGANDA</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>mart.ug@mart.ug</p>
                <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>+256 345 67890</p>
            </div>
            <div class="col-lg-8 col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <p>Subscribe with your email to get product updates</p>
                        <form action="">
                            <div class="input-group">
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-secondary">
                    ...
                    by
                    <a class="text-primary" href="">NAD Group 1</a>
                </p>
            </div>
